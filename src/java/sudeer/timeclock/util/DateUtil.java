...
public class DateUtil {
    ...
    {           
        DateFormat dateFormat = new SimpleDateFormat(DateUtil.DATE_TIME_FORMAT);
        Date date = new Date();
    ...
    {
        DateFormat dateFormat = new SimpleDateFormat(DateUtil.DATE_FORMAT);
        Date date = new Date();
        return dateFormat.format(date);
    }
    ...
    {
        DateFormat dateFormat = new SimpleDateFormat(DateUtil.FILE_DATE_FORMAT);
        Date date = new Date();
        return dateFormat.format(date);
    }
    ...
    {
        DateFormat dateFormat = new SimpleDateFormat(DateUtil.TIME_FORMAT);
        Date date = new Date();
        return dateFormat.format(date);
    }
